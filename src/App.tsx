...
import hansImgLow from './assets/IMG_9921_matte_look_1440_lowres.jpeg'
...
function App() {
  ...
  return (
    <ThemeProvider theme={CustomTheme}>
      <FullHeightWrapper backgroundColor="#48484a" backgroundImg={hansImg} backgroundImgLow={hansImgLow} height={downPhone ? "100vh" : "100vh"} >
        <LandingPage />
      </FullHeightWrapper>
